...
public class SqlLiteActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        int i = v.getId();//点击创建数据库库
        if (i == R.id.instablish) {// 创建SQLiteOpenHelper子类对象
            ...
            //点击更新数据
        } else if (i == R.id.upgrade) {// 创建SQLiteOpenHelper子类对象
            ...
            // 创建DatabaseHelper对象
            MySQLiteOpenHelper dbHelper4 = new MySQLiteOpenHelper(SqlLiteActivity.this, "test_carson", 2);
            ...
            MySQLiteOpenHelper dbHelper2 = new MySQLiteOpenHelper(SqlLiteActivity.this, "test_carson", 2);
            ...
            // 创建DatabaseHelper对象
            MySQLiteOpenHelper dbHelper3 = new MySQLiteOpenHelper(SqlLiteActivity.this, "test_carson", 2);
            ...
            //点击删除数据库
        } else if (i == R.id.delete_database) {
            System.out.println("删除数据库");

            MySQLiteOpenHelper dbHelper5 = new MySQLiteOpenHelper(SqlLiteActivity.this,
                    "test_carson", 2);
