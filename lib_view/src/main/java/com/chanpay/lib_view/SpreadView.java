...
public class SpreadView extends View {
    ...
    public SpreadView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        int centerColor = a.getColor(R.styleable.SpreadView_spread_center_color,  Color.GREEN);
        int spreadColor = a.getColor(R.styleable.SpreadView_spread_spread_color,  Color.GREEN);
